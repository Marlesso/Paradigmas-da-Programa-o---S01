...
(setq lista-oc
      (list
       (make-ocorrencia :nome "Ritual da Estátua"
                        :ritual "Invocação"
                        :nivel-medo 40
                        :agentes-enviados 2)
       ...
       (make-ocorrencia :nome "Corredor Sussurrante"
                        :ritual "Murmúrio"
                        :nivel-medo 70
                        :agentes-enviados 4)

       (make-ocorrencia :nome "Floresta da Névoa"
                        :ritual "Assombração"
                        :nivel-medo 55
                        :agentes-enviados 3)

       (make-ocorrencia :nome "Sala Invertida"
                        :ritual "Ruptura"
                        :nivel-medo 120
                        :agentes-enviados 6)))
