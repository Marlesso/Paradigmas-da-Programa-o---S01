...
const Armin = new Soldado('Armin', 'Modelo-B');
const Mikasa = new Soldado('Mikasa', 'Modelo-C');
const Eren = new Soldado('Eren', 'Modelo-D');

let esquadraoLevi = new Esquadrao(Levi, [Armin, Mikasa]);
