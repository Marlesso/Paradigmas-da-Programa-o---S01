...
eventoA = Evento [Banda "The Beatles" "Rock" 10000, Banda "Queen" "Rock" 15000] Encerrado
eventoB = Evento [Banda "Iron Maiden" "Metal" 20000, Banda "AC/DC" "Rock" 25000] Ativo
eventoC = Evento [Banda "Linkin Park" "Rock" 30000, Banda "Slayer" "Metal" 35000] Cancelado
