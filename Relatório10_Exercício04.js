...
const especialistaA = new Especialista("Ging Freecss", 35, "Ruínas da Cidade Perdida", "Arqueologia");
const especialistaB = new Especialista("Kurapika", 17, "Sede da Associação", "Corrente Especial");
const manipuladorC = new Manipulador("Shalnark", 24, "Floresta de Kukuroo", "Controle de Pessoas");
const manipuladorD = new Manipulador("Shalnark", 24, "Floresta de Kukuroo", "Controle de Pessoas");
