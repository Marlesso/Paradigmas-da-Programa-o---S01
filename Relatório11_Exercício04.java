...
public class Main {
  public static void main(String[] args) {
      PadraoAtaque fogo = new PadraoAtaque("Chamas Carmesin", 120);
      PadraoAtaque raio = new PadraoAtaque("Relâmpago Ascendente", 150);
      PadraoAtaque gelo = new PadraoAtaque("Sopro Congelante", 90);


      Boss b1 = new Boss("Golem de Pedra", "B001", "Magia");
      b1.adicionarAtaque(fogo);
      b1.adicionarAtaque(gelo);

      BossMagico b2 = new BossMagico("Fenrir", "B002", "Ataque físico");
