...
class Menu {
  ...
  public void listarItens(){
    for (Cafe item : itens) {
      System.out.println("Nome: " + item.nome + ", Pre├žo: " + item.calcularPrecoFinal());
    }
  }
}
...
public class Main {
  public static void main(String[] args) {
    ...
    Cafe comum = new Cafe("Café Preto", 5.00);
    CafeGourmet gourmet = new CafeGourmet("Café Gourmet", 7.50, 2.00);
