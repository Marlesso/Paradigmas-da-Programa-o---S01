...
class Program {
  public static void Main (string[] args) {
    ...
    ferramentas.Add(new Ferramenta("Capa"));

    Maga frieren = new Maga("Frieren", ferramentas);

    frieren.grimorio.AdicionarFeitico(new Feitico("Zoltraak"));
    frieren.grimorio.AdicionarFeitico(new Feitico("Campo de flores"));
    frieren.grimorio.AdicionarFeitico(new Feitico("Magia defenciva"));
